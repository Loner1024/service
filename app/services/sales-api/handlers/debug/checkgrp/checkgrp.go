...
// Do not response by just returning an error because further up in the call
...
// If the app deployed to a Kubernetes cluster, it will also return pod,node,and namespace
// details via the Downward API. The Kubernetes environment variables
